...
(function ($) {
    $.fn.Catalogo = function (m) {
        ...
        m.empty = m.empty || "No se encontraron resultados para su busqueda";
        m.edit = m.edit || false;
        ...
        if (typeof (m.datos) != 'undefined' && m.datos.length == 0) {
            html += '<div class="row"><h1 class="text-center m-t-10"><small>' + m.empty + '</small></div>';
        }
        ...
        if (m.pag && m.datos.length > 0) {
            ...
            //var nPag = 10
            if (m.pagDato.nPageTot > 5) {

                fin = ini + 4;

                if (m.pagDato.nPage > 2 && m.pagDato.nPage <= (m.pagDato.nPageTot - 3)) {
                    ini = m.pagDato.nPage - 2;
                    fin = ini + 4;
                } else if (m.pagDato.nPage > (m.pagDato.nPageTot - 3)) {
                    ini = m.pagDato.nPageTot - 4;
